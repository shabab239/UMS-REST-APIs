...
(1,'123 University Rd, Patuakhali',NULL,'O+','01700000001','1970-05-15','john.smith@email.com','Male','2024-01-01','Dr. John Smith','ADMIN','ACTIVE',1),
(2,'456 University St, Patuakhali',NULL,'A-','01700000002','1985-09-22','alice.johnson@email.com','Female','2024-02-01','Alice Johnson','STAFF','ACTIVE',1),
(3,'789 University Ave, Patuakhali',NULL,'B+','01700000003','1990-12-05','robert.brown@email.com','Male','2024-03-01','Robert Brown','STAFF','ACTIVE',1),
(4,'101 University Blvd, Patuakhali',NULL,'AB-','01700000004','1980-11-11','emily.davis@email.com','Female','2024-04-01','Emily Davis','TEACHER','ACTIVE',1),
(5,'202 University Park, Patuakhali',NULL,'O-','01700000005','1988-04-12','michael.wilson@email.com','Male','2024-05-01','Michael Wilson','TEACHER','ACTIVE',1),
(6,'303 University Ln, Patuakhali',NULL,'B-','01700000006','1992-07-30','jessica.taylor@email.com','Female','2024-06-01','Jessica Taylor','TEACHER','ACTIVE',1),
(7,'12 Main Rd, Dhaka',NULL,'A+','01900000001','1968-03-10','sarah.green@email.com','Female','2024-01-15','Dr. Sarah Green','ADMIN','ACTIVE',2),
(8,'34 Main St, Dhaka',NULL,'O+','01900000002','1982-08-20','david.lee@email.com','Male','2024-02-15','David Lee','STAFF','ACTIVE',2),
(9,'56 Main Ave, Dhaka',NULL,'AB+','01900000003','1987-11-05','laura.martinez@email.com','Female','2024-03-15','Laura Martinez','STAFF','ACTIVE',2),
(10,'78 Main Blvd, Dhaka',NULL,'B-','01900000004','1975-04-22','james.clark@email.com','Male','2024-04-15','James Clark','TEACHER','ACTIVE',2),
(11,'90 Main Ln, Dhaka',NULL,'O+','01900000005','1983-12-10','sophia.white@email.com','Female','2024-05-15','Sophia White','TEACHER','ACTIVE',2),
(12,'101 Main Park, Dhaka',NULL,'A-','01900000006','1990-06-01','william.harris@email.com','Male','2024-06-15','William Harris','TEACHER','ACTIVE',2),
(13,'404 University St, Patuakhali',NULL,'AB+','01700000007','1985-02-10','anna.williams@email.com','Female','2024-07-01','Anna Williams','TEACHER','ACTIVE',1),
(14,'505 University Ave, Patuakhali',NULL,'B+','01700000008','1991-10-15','liam.adams@email.com','Male','2024-08-01','Liam Adams','TEACHER','ACTIVE',1),
(15,'606 University Blvd, Patuakhali',NULL,'O+','01700000009','1988-06-22','olivia.scott@email.com','Female','2024-09-01','Olivia Scott','TEACHER','ACTIVE',1),
(16,'707 University Ln, Patuakhali',NULL,'A-','01700000010','1994-04-30','ethan.harris@email.com','Male','2024-10-01','Ethan Harris','TEACHER','ACTIVE',1),
(17,'808 University Park, Patuakhali',NULL,'B-','01700000011','1992-01-12','sophia.miller@email.com','Female','2024-11-01','Sophia Miller','TEACHER','ACTIVE',1),
(18,'909 University Dr, Patuakhali',NULL,'AB-','01700000012','1990-07-08','jacob.wilson@email.com','Male','2024-12-01','Jacob Wilson','TEACHER','ACTIVE',1),
(19,'112 Main Rd, Dhaka',NULL,'O-','01900000007','1983-05-16','ava.brown@email.com','Female','2024-07-15','Ava Brown','TEACHER','ACTIVE',2),
(20,'223 Main St, Dhaka',NULL,'A+','01900000008','1989-09-24','mason.green@email.com','Male','2024-08-15','Mason Green','TEACHER','ACTIVE',2),
(21,'334 Main Ave, Dhaka',NULL,'B+','01900000009','1990-11-30','isabella.miller@email.com','Female','2024-09-15','Isabella Miller','TEACHER','ACTIVE',2),
(22,'445 Main Blvd, Dhaka',NULL,'AB+','01900000010','1984-04-18','james.smith@email.com','Male','2024-10-15','James Smith','TEACHER','ACTIVE',2),
(23,'556 Main Ln, Dhaka',NULL,'O+','01900000011','1991-08-22','mia.davis@email.com','Female','2024-11-15','Mia Davis','TEACHER','ACTIVE',2),
(24,'667 Main Park, Dhaka',NULL,'A-','01900000012','1987-12-05','benjamin.johnson@email.com','Male','2024-12-15','Benjamin Johnson','TEACHER','ACTIVE',2);
